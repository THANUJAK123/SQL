...
show tables;
select * from producproductlinests;
where customerNumber=117;
alter table customers
add column email varchar(40);
update customers
set email='hi-hello@gmail.com' where customerNumber=117;
insert into customers values(117,'thanu','kamisetty','thanu',7675678,'andhra','atp','tdp','jhd',678564,'mumbai',6786,68790);
alter table customers
drop column email;
create table DUMMY(
sno int ,
...
scgpa decimal);
alter table DUMMY
add foreign key(sname) references student1(sname);
...
alter table Dummy
add unique(sname);
insert into Dummy values(1,'user1','music','2000-03-29',81.9),
(2,'user2','reading','2002-05-19',89.9),
(3,'user3','playing games','1998-03-17',91.9),
(4,'user4','dancing','2002-05-09',81.7),
(5,'user5','crafting','2001-07-14',79.6),
(6,'user6','painting','2008-05-26',81.3);
select * from dummy;
drop table dummy;
...
group by country;
select count(avg(creditlimit)) from customers
group by postalcode;
